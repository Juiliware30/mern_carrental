...
import Ttile from '../../components/owner/Title'
...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      <Ttile title="Add New Car" subTitle="Fill in details to list a new car for booking ,including pricing, availability and car specifications."/>
