  ...
  return  car ? (
    <div className=' px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
      ...
      <button  onClick={()=> navigate(-1)} className=' flex items-center gap-2 mb-6 text-gray-500 cursor-pointer'> 
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap:18 lg:gap-12'>
           ...
           transition={{ delay:0.3, duration:0.6}}
            onSubmit={handleSubmit} action="" className=' shadow-lg h-max sticky to-18 rounded-xl p-6 space-y-6 text-gray-500'> 
           ...
           <p className='text-sm text-center'>No Credit card required for resever</p>
           </motion.form>
        </div>
