...
const Banner = () => {
  return (
    ...
    justify-between px-8 min-md:pl-14 pt-10 bg-gradient-to-r from-[#0998FE] to-[#A9CFFF] max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>
        <div className='text-white'>
            ...
            text-primary rounde-lg text-sm mt-4 cursor-pointer'>List your car</motion.button>      
        </div>
        <motion.img 
