...
const Footer = () => {
  return (
     ...
     className='px-6 md:px-16  mg:px-24 xl:px-32 mt-60 text-sm text-gray-500'>
            ...
            transition={{duration:0.5,delay:0.4}}
                    className='max-w w-80 mt-3'>
                        Premium car rental service with a wide selction of luxury and everyday vehicles for all your driving needs.
                    </motion.p>
                ...
                <div>
                 ...
                 <div>
                    ...
                    <ul className='mt-3 flex flex-col gap-2 text-sm'>
                        ...
                        <li>San Francisco, India 422003</li>
                        <li>9652417852</li>
