...
export const  toggleCarAvailability = async(req,res)=>{
  try {
        ...
        //Cheking is car belongs to user 
...
// API to update car data
export const updateCar = async (req, res) => {
    try {
        const { _id } = req.user;
        const { carId } = req.params;
        let carUpdateData = JSON.parse(req.body.carData);
        const imageFile = req.file;
        ...
        if (imageFile) {
            ...
            carUpdateData.image = optimizedImageUrl;
        }

        await Car.findByIdAndUpdate(carId, carUpdateData);
...
export const getDashboardData = async(req ,res)=>{
    try {
        ...
        console.log("Booking details:", JSON.stringify(bookings, null, 2));
